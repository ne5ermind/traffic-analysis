...
Ссылки выше сохранены в том же виде, что и в исходном GitHub-репозитории.
Техническая документация реализации находится в каталоге [`docs/`](./docs/),
чтобы материалы исходного репозитория и код сервиса не смешивались.
